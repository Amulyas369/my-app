...
import Dropdown from "../pos/Dropdown";
...
const Header = (props) => {
  ...
  const userType = JSON.parse(sessionStorage.getItem("userProfile")).user_type;

  // Determine userRole using switch case
  let userRole;
  switch (userType) {
    case "brandadmin":
  ...
  const [selectedItem, setSelectedItem] = useState("User"); // default state
  ...
  useEffect(() => {
    const userProfile = JSON.parse(sessionStorage.getItem("userProfile"));
    if (userProfile) {
      updateSelectOptions(userProfile);
    }
  }, []);
  useEffect(() => {
    console.log("-----66", selectOptions);
  }, [selectOptions]);
  const handleSelect = () => {
  ...
  //   // Apply the theme change logic here, e.g., by adjusting the global state or context
  //   // This might involve adding or removing a class from the body, or changing a state that controls the theme
  // };
  ...
  return (
    <>
      <div className="header">
        ...
        <ul className="nav user-menu">
          {selectOptions.length > 0 && (
            <li>
              <DropdownComponent itemList={selectOptions} />
            </li>
          )}
      ...
      <div className="dropdown-menu dropdown-menu-right">
        <Link to="#" className="dropdown-item active" onClick={() => handleSelect('All')}>
          All
        </Link>
        <Link to="#" className="dropdown-item" onClick={() => handleSelect('OU')}>
          Outlet User
        </Link>
        <Link to="#" className="dropdown-item" onClick={() => handleSelect('BU')}>
          Brand User
        </Link>
        <Link to="#" className="dropdown-item" onClick={() => handleSelect('CU')}>
          Company User
        </Link>
      </div>
    </li> */}
              ...
              <div className="profilename">
                <div className="profileset">
                  ...
                  <div className="profilesets">
                    ...
                    <h5 className="user-role">{userRole}</h5>
                  </div>
                </div>
                <hr className="m-0" />
                <Link
                ...
                <div className="dropdown-item spacebwn">
                  Dark Mode
                  <ThemeSwitcher />
                </div>
                <hr className="m-0" />
